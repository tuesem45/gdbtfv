local OrionLib = loadstring(game:HttpGet("https://github.com/xiaoSB33/M416/raw/main/Ul.lua", true))()
 local Window =   OrionLib:MakeWindow({Name = "操逼脚本V2", HidePremium = false, SaveConfig = false, ConfigFolder = "rbxassetid://6026568198"}) 
...
LOL:AddLabel("作者：ai加缝合")
LOL:AddLabel("操脚本群号：1062967540")
LOL:AddLabel("操脚本V2")
LOL:AddLabel("谢谢大家支持脚本")
LOL:AddLabel("重大声明：此脚本全缝合 没有一点自己做的")
...
Tab:AddTextbox({
        ...
        Default = "",
        TextDisappear = true,
        Callback = function(cnm)
XA.Character.Humanoid.JumpPower = cnm
        end
})
...
Tab:AddTextbox({
        ...
        TextDisappear = true,
        Callback = function(cnm)
                XA.Character.Humanoid.WalkSpeed = cnm
        end
})
Tab:AddTextbox({
        Name = "操逼",
        Default = "",
        TextDisappear = true,
        Callback = function(jjbsb)
                game.Workspace.Gravity = jjbsb
        end
})
Tab:AddTextbox({
        Name = "操逼事件",
...
Tab:AddButton({
        Name = "江脚本V1",
        Callback = function()
        getgenv().Xiaojian="江脚本QQ群1062967540" loadstring(game:HttpGet("https://raw.githubusercontent.com/xiaoSB33/M416/refs/heads/main/%E6%B1%9FtdNB%2F%E6%B1%9FScript%20HUB%E9%AA%8C%E8%AF%81.lua"))()
          end
})
